          ...
          <Audiotime.Provider value={valueAudiotime}>
            <div>
              <div className="flex items-center bg-[#5499ff] p-2 gap-2 justify-center sticky top-0 shadow-xl">
                ...
                <a href="https://github.com/adielBm/lrc-generator" target="_blank" className="btn bg-slate-700 hover:bg-slate-900 text-gray-200 hover:text-gray-200 rounded-full">
                  <svg
